...
function Contact() {
  ...
  return (
    <div
      className="contact flex flex-col gap-28 my-56 mx-4 sm:mx-24 xl:mx-36 items-center"
      ref={ref}
    >
      <h2
      ...
      <div className="socials-list w-[80%] sm:w-[100%] flex max-sm:flex-col sm:flex-wrap justify-start sm:justify-center gap-14 text-xl">
        ...
        <a
          href="https://www.linkedin.com/in/danielemerald/"
          target="_blank"
          rel="noreferrer"
          className="social flex gap-5 items-center"
          style={animate.right}
